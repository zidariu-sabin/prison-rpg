...
public class DungeonCreator : MonoBehaviour
{
    ...
    {
        CreateDungeon();
        wallVertical.AddComponent<BoxCollider>();
        wallHorizontal.AddComponent<BoxCollider>();
    }
    ...
    public void CreateDungeon()
    {
        ...
        {
            SpawnPlayer(listOfRooms[0].BottomLeftAreaCorner, listOfRooms[0].TopRightAreaCorner);
        }
    }
    ...
    private void SpawnPlayer(Vector2 bottomLeftCorner, Vector2 topRightCorner)
    {
        ...
        playerPrefab.transform.position = center;
    }
}